...
import baseStyles from '../LpCareer.module.css';

import styles from './Complete.module.css';
import '../lp-career-tokens.css';

export const metadata: Metadata = buildPageMetadata(pages.counselingCompleteLpCareer, {
  noindex: true,
...
export default function Complete() {
  return (
    <div className={`lp-career ${jostLpCareer.variable} ${barlowSemiCondensedLpCareer.variable} ${baseStyles.LpCareer} ${styles.Complete}`}>
      <CanvasScale />
      <Header lpHref={lpCareerAsset(pages.lpCareer.url)} />
      <main className={styles.Complete__Main}>
        <div className={styles.Complete__Inner}>
            ...
            <ol className={styles.Complete__Steps}>
              ...
              <li>
                ...
                <div><h3>当日までにできればこちらの動画をご覧ください</h3>
                  <p>お時間があれば、ぜひ受講生様との対談動画を2~3本ご覧くださいませ。（1本10分以内です）<br />そうしていただくことで、当日は時間内により深い説明が可能になります。</p>
          ...
          <Link className={styles.Complete__Back} href={pages.lpCareer.url}>SiiDの紹介ページへ戻る <span aria-hidden="true">→</span></Link>
        </div>
      </main>
      <Footer />
      <CookieBanner />
