  ...
  const strengths = [
    {
      ...
      items: ['エンジニア歴14年以上の開発実績', '2,000人以上を選考し、150人以上のエンジニアを採用してきた経営人事経験', 'Adobe Japan等を含む内定実績'],
    },
    {
      icon: 'gear' as const,
    ...
    },
    {
      ...
      items: ['対人事/経営陣/技術者などタイプ別の模擬面接対策', 'ITエンジニア特化の履歴書/職務経歴書添削', '一流エンジニアとしてのマインド面も学べる'],
    },
    {
      icon: 'app' as const,
    ...
    },
    {
      ...
      title: '学び続けられる環境・仕組み',
      items: ['仕事や家庭と両立しながら進められる仕組みと体制', '小さな成功体験を積めるカリキュラム', 'Zoomやチャットで講師陣に気軽に相談できる体制', '同じ志をもった同級生や卒業生がいる永久コミュニティ'],
    },
  ];
