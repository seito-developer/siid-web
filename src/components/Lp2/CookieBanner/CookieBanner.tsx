...
import { LP2_CONSENT_STORAGE_KEY } from '@/components/Analytics/analyticsConfig';
...
// lp-2 のパスに限って beforeInteractive のスクリプトとして出している。
// ここでは利用者の選択を Consent Mode の update として dataLayer に流す。

const STORAGE_KEY = LP2_CONSENT_STORAGE_KEY;
