...
export default function ZoomContents() {
  return (
    <div>
      <img src="/images/community/online-zoom.png" alt="毎回多くの方に参加いただいてます" className={styles.topImage} />
      <ul className={styles.iconWrapper}>
        <li className={styles.iconItem}>
          <img src="/images/community/zoom-icon-01.svg" className={styles.icons} />
