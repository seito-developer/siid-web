...
const SOURCES = {
  pc: { src: '/videos/lp-career/fv-pc.mp4', poster: '/videos/lp-career/fv-pc-poster.webp' },
  sp: { src: '/videos/lp-career/fv-sp.mp4', poster: '/videos/lp-career/fv-sp-poster.webp' },
};
...
export default function FvVideo() {
  ...
  return (
    <video
      ...
      playsInline
      preload="none"
      poster={source ? lpCareerAsset(source.poster) : undefined}
      src={source && canLoadBody ? lpCareerAsset(source.src) : undefined}
      aria-hidden="true"
    />
  );
}
