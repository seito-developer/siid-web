...
import { LP_CAREER_STEPS } from '@/constants/lpCareerSteps';
        ...
        <ol className={styles.Step__List}>
          {LP_CAREER_STEPS.map((step) => (
            <li key={step.no} className={styles.Step__Item}>
              ...
              <Image className={styles.Step__Visual} src={lpCareerAsset(`/images/lp-career/sp/step-visual-${Number(step.no)}.webp`)} width={682} height={280} alt="" />
