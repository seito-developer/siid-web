import { LP_CAREER_COURSE_TABLE } from '@/constants/lpCareerCourseTable';

import SectionBg from '../SectionBg/SectionBg';

import styles from './Graph.module.css';

// コース比較表(docs/spec/lp-career-sections/12-graph.md と 12-graph.notes.md)。
//
...
export default function Graph() {
  const { head, rows } = LP_CAREER_COURSE_TABLE;
