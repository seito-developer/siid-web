import { LP_CAREER_DIFFERENCE_POINTS, LP_CAREER_DIFFERENCE_TABLE } from '@/constants/lpCareerDifference';
...
export default function Difference() {
  const { head, rows } = LP_CAREER_DIFFERENCE_TABLE;
    ...
    <section className={styles.Difference} id="difference">
      ...
      <div className={styles.Difference__Inner}>
        ...
        <ul className={styles.Difference__Points}>
          {LP_CAREER_DIFFERENCE_POINTS.map((point) => (
