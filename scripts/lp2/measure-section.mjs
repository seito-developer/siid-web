...
//
//   node scripts/lp2/measure-section.mjs about pc
//   node scripts/lp2/measure-section.mjs about sp
//
// SP は CSS px で出るので、カンプ(@2x)の値と比べるときは 2 倍する。
// docs/spec/lp2-sections/ の実測値と突き合わせて座標を詰めるために使う。
import { chromium } from 'playwright';

const id = process.argv[2];
const side = process.argv[3] === 'sp' ? 'sp' : 'pc';
if (!id) {
  console.error('usage: node scripts/lp2/measure-section.mjs <セクションid> [pc|sp]');
  process.exit(1);
}
