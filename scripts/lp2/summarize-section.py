...
"""セクション実測データ(Markdown)を実装しやすい形に要約する。
  ...
  python3 scripts/lp2/summarize-section.py 05-instructor --side PC [--origin 0]
...
DOC_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "..", "docs", "spec", "lp2-sections")
