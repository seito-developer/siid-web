...
docs/spec/07_lp-career-renewal.md §13.1 / §13.2 の完了条件をレビューエージェントが
機械的に判定するためのツール。

  python3 scripts/lp-career/compare.py \\
...
try:
    ...
    sys.exit("依存が不足しています: pip install -r scripts/lp-career/requirements.txt")
