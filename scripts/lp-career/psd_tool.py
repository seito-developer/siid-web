#!/usr/bin/env python3
"""LP リニューアル(/siid/lp-career)用の PSD 解析・書き出しツール。

入稿された Photoshop データ(docs/spec/07_lp-career-renewal.md §2)から、実装に必要な
...
使用例:
  ...
  python3 scripts/lp-career/psd_tool.py data   ~/Downloads/260902_seitosama/pc --out-dir tmp/psd-data/pc
  python3 scripts/lp-career/psd_tool.py render ~/Downloads/260902_seitosama/pc --out-dir tmp/psd-ref/pc
  python3 scripts/lp-career/psd_tool.py tree   ~/Downloads/260902_seitosama/pc/pc1.psd
  python3 scripts/lp-career/psd_tool.py export ~/Downloads/260902_seitosama/pc/pc1.psd \\
      --path 'fv/medal/1' --out public/images/lp-career/fv-medal-1.webp

依存: scripts/lp-career/requirements.txt
"""
    ...
    形式:
      {
        ...
        "out_dir": "public/images/lp-career",
        "assets": [
