...
//
//   node scripts/lp-career/shoot-sections.mjs pc
//   node scripts/lp-career/shoot-sections.mjs sp
//
// 撮影幅は完了条件どおり PC 1440px / SP 375px(docs/spec/07_lp-career-renewal.md §13)。
